...
<html>
<head>
	<title>Shaadi Vibes :: Page not found</title>
...
*/
body{
	background: url({{ asset('public/assets/imgs/bg1.png') }});
...
<body>
		...
		<div class="wrap">
			...
			<div class="header">
				<div class="logo">
					<h1><a href="http://www.shaadivibes.com">Ohh</a></h1>
				</div>
			</div>
			<!---End-header---->
			<!--start-content------>
			<div class="content">
				<img src="{{ asset('public/assets/imgs/error-img.png') }}" title="error" />
				<p><span><label>O</label>hh.....</span>You Requested the page that is no longer There.</p>
				<a href="http://www.shaadivibes.com">Back To Home</a>
				<div class="copy-right">
					<p>Copyright © 2017 <a href="http://www.shaadivibes.com">Shaadi Vibes</a>. All rights reserved. </p>
				</div>
			</div>
			<!--End-Cotent------>
		</div>
